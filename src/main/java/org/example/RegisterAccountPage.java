...
public class RegisterAccountPage extends BasePage {
    ...
    private By subscribeButtonYes = By.xpath("//*[@id=\"content\"]/form/fieldset[3]/div/div/div[1]/label");
    private By subscribeButtonNo= By.xpath("//*[@id=\"content\"]/form/fieldset[3]/div/div/div[2]/label");
    ...
    public void setPasswordConfirmInput(String passwordConfirm) {driver.findElement(passwordConfirmInput).sendKeys(passwordConfirm);}

    public void checkPrivacyPolicy() {driver.findElement(privacyPolicyCheckbox).click();}
